export default {
  ...
  bondScenes: {
    acquaintance: {
      ...
      choice: {
        prompt:
          '"There. That\'s the whole of it, and rather more than I meant to say tonight."',
        options: [
          {
            key: "kind",
          ...
          },
          {
            ...
            style: 1,
            close:
              '"Oh, I drafted several versions in my head. Discarded most of them. The one about the east path took the most editing, if you\'re curious."\n\n"...It\'s been some time since anyone made me smile at my own foolishness. I\'ll be thinking on that for a while."',
          },
          {
            key: "bold",
            ...
            style: 4,
            close:
              '*There\'s a pause rather longer than the question should need.*\n\n"Now that is a question with a door behind it."\n\n"Ask me again sometime, when it\'s later and I\'m tired enough not to mind opening it. Good night."',
          },
        ],
      },
      keepsake: {
    ...
    friend: {
      ...
      choice: {
        prompt:
          "\"Go on, then. I'm bracing myself, and I'd rather have it over with.\"",
        options: [
          {
            key: "kind",
          ...
          },
          {
            ...
            style: 4,
            close:
              '*He answers it, plainly, the first time, without turning it around, and then there\'s a long silence while you both notice that he did.*\n\n"...Huh," *he says quietly.* "Look at that. Still works, apparently."',
          },
        ],
      },
      keepsake: {
      ...
      choice: {
        ...
        options: [
          ...
          },
          {
            ...
            style: 1,
            close:
              '"Oh, we became close. Quite close, really. He knows my name, my face, and my opinion of his paperwork."\n\n"Eat, please, while it\'s hot. I\'ll be unbearable if you let it go cold."',
          },
          {
            key: "bold",
    ...
    confidant: {
      ...
      choice: {
        prompt:
          "\"Please, don't be gentle about it. Gentle is what I get from the rest of the house, and I've had my fill.\"",
        options: [
          {
            key: "kind",
  ...
  approach: {
    ...
    bound: ["Come back to bed", "Check his hands", "Say it slower", "Stay"],
  },
  responses: {
    kind: {
      new: [
      ...
      spark: ["Tell him to stop angling", "Take his hand", "Say yes, gently"],
      close: [
    ...
    neutral: {
      ...
      spark: ["Leave him guessing", "Step around him", "Let the question hang"],
      close: [
