export default {
  ...
  bondScenes: {
    acquaintance: {
      beats: [
        '**{firstName}**: "is this you"\n\n"rui put your name in the thingy for me. i pressed it four times. sorry if it went four times"',
        "*A voice note arrives instead of a message. He sounds like he is walking.*\n\n\"You smell the same every time. Did you know that? Most people change: angry in the morning, tired at night, scared when Edward walks past. All different smells, all day.\"\n\n\"You've come {timesMet} times and you smell the same every single one. Nobody does that.\"\n\n\"I don't know what it means yet. I wanted to say it out loud though.\"",
      ],
      choice: {
        prompt: "\"Is that a rude thing to say? Rui says half my things are rude. Tell me if it's a rude one.\"",
        options: [
          {
            key: "kind",
          ...
          },
          {
            ...
            style: 1,
            close: "\"Cold outside and paper and the soap in the west block.\"\n\n*He says it instantly, with no hesitation whatsoever.*\n\n\"...That was too fast, wasn't it. Rui says when I know things too fast it makes people do the face. Did you do the face?\"",
          },
          {
            key: "bold",
            label: "Ask him to walk with you",
            style: 4,
            close: "*The recording stops. A new one starts about ten seconds later and he is very obviously somewhere else and moving faster.*\n\n\"Yes. Now? Tomorrow. Both. Walking's the best one. You can be next to someone for ages and nobody has to do talking.\"\n\n\"That's my favorite thing. I've never had anyone to do it with.\"",
          },
        ],
      },
      keepsake: {
    ...
    closeFriend: {
      beats: [
        '**{firstName}**: "come to my room. bring nothing. dont bring rui"',
    ...
    devoted: {
      beats: [
        '**{firstName}**: "i did a bad thing and im telling you before rui does"',
    ...
    soulbound: {
      beats: [
        ...
        "\"{timesMet} times. I counted every one, even the ones in the far room where I couldn't see you.\"\n\n\"I asked Rui how to say a thing and he asked what thing and I wouldn't tell him, and he laughed, and then he stopped laughing and helped me for two hours.\"",
