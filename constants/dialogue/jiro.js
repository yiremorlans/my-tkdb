export default {
  ...
  temperamentDialogue: {
    ...
    known: [
      ...
      '"You\'re early. I approve, marginally."',
      '"Sit still. I\'m not finished looking at you."',
      '"Most people are spooked at the specimens. You didn\'t. Noted."',
      '"I keep count of how often you show up. Don\'t ask why."',
      "\"You brought coffee. I didn't ask for it. I'll take it anyway.\"",
      '"Your color\'s better than last week."',
      "\"Don't apologize for interrupting. You didn't do anything wrong.\"",
    ],
    warm: [
      ...
      '"I rationed the good tea. It\'s yours if you want it."',
      '"You worry about me. I\'ve stopped telling you to stop."',
      "\"Don't thank me. I'd have done it regardless. ...Still, you're welcome.\"",
      '"I noted your habits. Not for research. Habit, I suppose."',
      '"You interrupted my rounds. I didn\'t mind. Log that as unusual."',
      "\"Yuri says I've gotten easier to talk to. That's you, not me.\"",
      '"I kept the chair open. Sit, if you\'re staying."',
      "\"You checked on me first. That's... backwards. I don't hate it.\"",
      '"I don\'t do small talk. With you, apparently, I make exceptions."',
      '"Take the blanket. I run warm enough without it."',
      "\"I've stopped minding the interruptions. Don't tell anyone.\"",
      "\"You look better when you're here. That's an observation, not a compliment.\"",
      '"Stay a while. The lab\'s quieter with you in it."',
    ],
    spark: [
