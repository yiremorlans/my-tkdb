export default {
  ...
  // shohei.js/subaru.js/zenji.js/haku.js/elias.js/mio.js/shion.js. Two labels
  // had no genuine beat match ("Tell him to sleep too", "Let him check you
  // over") and were dropped rather than force-placed.
