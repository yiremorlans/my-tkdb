export default {
  ...
  bondScenes: {
    ...
    friend: {
      beats: [
        "**{firstName}**: right.\n\nnoticed something and it's messing with my head.",
        "u hit me with {favResponse}.\n\nevery time.\n\ndoesn't matter what mood I'm in, doesn't matter if I forgot ur name an hour ago.\n\neveryone else goes careful after that.\n\nor sad about it.\n\nor starts explaining who they are before I've asked, which is the worst one.\n\nu don't.\n\nweird.",
      ],
      choice: {
        prompt: "so what's ur angle. everyone's got an angle.",
        options: [
          {
            key: "kind",
          ...
          },
          {
            ...
            style: 4,
            close:
              "hate asking.\n\neveryone does the math on how much of them I've lost, right there in front of me.\n\nworst two seconds there is.\n\n…yours doesn't.\n\nthat's it.\n\ntook me forever to say it.",
          },
        ],
      },
      keepsake: {
