export default {
  ...
  temperamentDialogue: {
    ...
    known: [
      ...
      '"Careful carrying all that. Actually, here, just let me."',
      '"The cat likes you. Don\'t ask me how I can tell. I just can."',
      '"Tea, same as always? I remembered."',
      '"You\'re not in a hurry, are you? Good. Stay a minute."',
      '"I order half these snacks because you like them. Don\'t tell anyone."',
      '"How\'s your week been? No, really, I want to know."',
      "\"That chair's for the cat. She's never once used it.\"",
      '"Sit if you like. I don\'t mind the company."',
    ],
    warm: [
      ...
      '"You\'re sleeping alright? Ah, sorry, old habits."',
      '"I\'ve been staying open a bit later these days. No particular reason."',
      "\"You didn't have to bring anything. ...I'm glad you did, though.\"",
      '"You\'re running a bit late today. I was starting to wonder."',
    ...
    spark: [
      ...
      '"You make a grown man feel rather silly. I don\'t mind it."',
    ],
    close: [
