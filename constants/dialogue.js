  ...
  jin: {
    dialogue: {
      new: [
        ...
        "Frostheim's leader is holding court with no one at all. He notices you, and says nothing.",
        "He weighs you the way one weighs a debt — quickly, and without much interest.",
        "Ice creeps along the window frame beside him. He lights a cigarette.",
      ],
      known: [
        "He recognizes you now. He makes a point of not showing it.",
        '"You again," he says, and returns to smoking his cigarette. He doesn\'t ask you to leave.',
        "Twice this week. He's noticed. He would deny having counted.",
        "The dismissal comes a beat slower than it used to.",
        "He looks up, places you, and looks back down. That is progress.",
      ],
      warm: [
    ...
    temperamentDialogue: {
      new: [
        ...
        '"State your business. I have very little patience today."',
        '"Frostheim does not entertain wanderers. Explain yourself."',
        '"Do you always walk into places you don\'t belong?"',
      ...
      known: [
        ...
        '"I had assumed you would stop coming. Evidently not."',
        '"Speak. I\'ll allow it this once."',
  ...
  kaito: {
    dialogue: {
      new: [
        ...
        "He's halfway through a story to nobody in particular. You've just become the audience.",
        'He waves so hard he nearly takes out a lamp. "Hey! Hey, over here!"',
        "All that noise in a house this cold has to come from somewhere. It's coming from him.",
      ],
      known: [
        ...
        "He waves before he's fully turned around and nearly takes out a chair.",
    ...
    temperamentDialogue: {
      new: [
        ...
        '"Hey! You want the tour? I give a great tour. Probably."',
      ...
      known: [
        ...
        "\"Wait wait wait, don't go yet, I've got something to tell you.\"",
      ...
      warm: [
        ...
        '"Man, this place gets way less boring when you show up."',
      ],
      spark: [
  ...
  lucas: {
    dialogue: {
      new: [
        ...
        "He's tending to something small and broken with far more care than it warrants.",
      ...
      known: [
        ...
        "He holds the door a moment longer than necessary and blames the wind.",
    ...
    temperamentDialogue: {
      new: [
        ...
        '"Please — watch your step. The floor isn\'t kind."',
      ],
      known: [
        '"Ah — it\'s you. I mean, of course it is. Hello."',
        "\"You've been coming by more often. That's... that's good.\"",
        "\"May I ask how you've been? You needn't answer.\"",
        '"Please don\'t stand in the draft. Here — this spot is better."',
  ...
  tohma: {
    dialogue: {
      new: [
        ...
        '"Name and reason," he says. Not unkindly. Just efficiently.',
    ...
    temperamentDialogue: {
      new: [
        ...
        '"This area is monitored. You should know that before you go further."',
        "\"You're unregistered. That's not a threat, it's an observation.\"",
        "\"If you're lost, say so. I don't have time for pride.\"",
        "\"Stand there. I'll determine whether you're a problem.\"",
      ],
      known: [
        "\"You're on the list now. That's neither good nor bad.\"",
        '"Recognized. Proceed."',
  ...
  alan: {
    dialogue: {
      new: [
        ...
        "He glances up once, decides you're not a threat, and goes back to the bolt.",
      ],
      known: [
        ...
        "He glances up, sees it's you, and doesn't tense. That's the whole change.",
    ...
    temperamentDialogue: {
      new: [
        ...
        '"You need something, or are you just wandering?"',
      ...
      known: [
        ...
        '"Still coming around, huh. Suit yourself."',
      ...
      warm: [
        ...
        '"Sit. I\'m almost done."',
        '"You came back. Good."',
        '"Grab that wrench. Might as well be useful."',
  ...
  leo: {
    dialogue: {
      new: [
        ...
        "He's holding court and bored of it — right up until you walk in.",
      ],
      known: [
        ...
        "You're a recurring character now. He appears to find that entertaining.",
      ...
      warm: [
        ...
        "Someone else tries to talk to him. He doesn't hear a word of it.",
      ],
      spark: [
    ...
    temperamentDialogue: {
      new: [
        ...
        '"Don\'t flinch. It ruins the shot."',
      ],
      known: [
        ...
        '"You\'re getting less fun to scare. Fix that."',
      ],
      warm: [
        '"Finally came back, huh? I was getting bored without you."',
        '"Look who crawled back for more. I approve."',
  ...
  shohei: {
    dialogue: {
      new: [
        ...
        "For a Vagastrom kid working a truck at this hour, he looks unreasonably happy about it.",
      ],
      known: [
        ...
        "He talks you through what he's doing while he does it, as though you'd asked. You hadn't.",
      ...
      warm: [
        ...
        "The truck closes at two. He stopped minding when you stay past it a long time ago.",
      ],
      spark: [
    ...
    temperamentDialogue: {
      new: [
        ...
        "\"First time at the truck? Then you don't get to order. I'll pick.\"",
        '"Careful, that counter\'s hot. ...Told you. You okay?"',
      ...
      known: [
        ...
        "\"I'm testing something new. You're the taste test. Congratulations.\"",
      ],
      warm: [
        ...
        '"Perfect timing — this just came off the heat."',
  ...
  subaru: {
    dialogue: {
      new: [
        ...
        "He's been working since before dawn and would be mortified if you pointed that out.",
      ...
      known: [
        ...
        "He asks whether you found the place all right. He asked last time too.",
      ],
      warm: [
        ...
        "He asks how you are before he's asked anything about himself. As usual.",
      ],
      spark: [
    ...
    temperamentDialogue: {
      new: [
        ...
        '"Forgive the state of things. I haven\'t finished the evening rounds."',
      ...
      known: [
        ...
        '"You found your way without help this time. I\'m glad."',
      ...
      warm: [
        ...
        "\"The tea's still hot. That's fortunate timing on your part.\"",
  ...
  zenji: {
    dialogue: {
      new: [
        ...
        "He looks at you for a while, kindly, the way one reads a poem twice.",
      ],
      known: [
        '"The wanderer returns," he says, pleased. "That makes you something else now."',
        "He's started a verse he intends to finish only when you're there to hear it.",
        "He offers your name back to you like a good line he's been holding.",
        "The bow is the same. The pause before it is not.",
  ...
  haku: {
    dialogue: {
      new: [
        ...
        '"How fortunate," he says, in the tone of someone who has said it a thousand times.',
        "He offers his hand, palm up, with the practiced grace of a shrine ceremony.",
        "The courtesy is flawless. The curiosity underneath it is not quite hidden.",
      ],
      known: [
        ...
        "\"You've been about,\" he observes, as though he hadn't been keeping track.",
      ...
      warm: [
        ...
        "The formal address slips once. He recovers instantly and pretends it never happened.",
      ],
      spark: [
    ...
    temperamentDialogue: {
      new: [
        ...
        '"A pleasure, truly. Shall I be charming, or would you prefer honest?"',
      ],
      known: [
        ...
        '"Don\'t look so pleased. ...Very well. Look as pleased as you like."',
      ],
      warm: [
  ...
  elias: {
    dialogue: {
      new: [
        ...
        "He's leaning where he shouldn't be, doing nothing, extremely well.",
        "The coin walks across his knuckles. He watches you watch it. That was the point.",
        "He smiles like it's free. It isn't, and you both know it.",
      ],
      known: [
        "He's stopped doing the coin trick. He's decided you'd see through it.",
      ...
      warm: [
        ...
        "He offers you the coin. No trick. He checks twice to make sure you noticed there was no trick.",
        "He looks tired tonight, and doesn't bother hiding it from you specifically.",
      ],
      spark: [
        "The drawl drops half an octave. That one isn't for the room.",
    ...
    temperamentDialogue: {
      new: [
        ...
        '"Pick a hand. Go on. I\'ll even let you win the first one."',
        "\"You've got good instincts, walking slow like that. Keep 'em.\"",
        "\"Don't mind me. I'm just the scenery these days.\"",
      ],
      known: [
        '"Well. If it isn\'t the persistent one."',
        '"No tricks today. You\'d only spoil them."',
      ...
      warm: [
        ...
        '"Long night. Sit with me and make it a shorter one."',
      ],
      spark: [
    ...
    responses: {
      ...
      playful: {
        new: [
          ...
          "Guess the wrong hand on purpose",
        ...
        close: ["Play his game back", "Pickpocket his coin", "Out-drawl him"],
        bound: [
          "Check his hands anyway",
  ...
  jo: {
    dialogue: {
      new: {
        uniform: [
          ...
          "He takes the room the way other people take a breath — completely, and without effort.",
          "He's rehearsing alone, and it is still the best thing you've seen all week.",
          "The applause hasn't started yet. He's already bowing to it.",
        ],
        casual: [
          "The spotlight finds her as she commands the stage with magnetic presence.",
          "She takes the room the way other people take a breath — completely, and without effort.",
          "She's rehearsing alone, and it is still the best thing you've seen all week.",
          "The applause hasn't started yet. She's already bowing to it.",
        ],
      },
      known: {
        uniform: [
          "He knows your face in the crowd now, and plays half a beat toward it.",
          '"You came back," he says, delighted, as though attendance were a compliment. It is.',
          "He promises nothing and signs nothing, and still makes it feel like a favor.",
          "He remembers where you sat last time. He glances there first.",
        ],
        casual: [
          "She knows your face in the crowd now, and plays half a beat toward it.",
          '"You came back," she says, delighted, as though attendance were a compliment. It is.',
          "She promises nothing and signs nothing, and still makes it feel like a favor.",
          "She remembers where you sat last time. She glances there first.",
        ],
      },
      warm: {
        uniform: [
          "He lights up the moment he sees you, the star already in motion for you.",
          "He plays the whole number to one seat in the house. Yours.",
          "He breaks character to grin at you, then puts it back on, badly.",
          '"Watch this part," he says, delighted. "I put it in for you."',
        ],
        casual: [
          "She lights up the moment she sees you, the star already in motion for you.",
          "She plays the whole number to one seat in the house. Yours.",
          "She breaks character to grin at you, then puts it back on, badly.",
          '"Watch this part," she says, delighted. "I put it in for you."',
        ],
      },
      spark: {
        uniform: [
    ...
    temperamentDialogue: {
      new: [
        ...
        "\"You're staring. Don't stop — it's the correct response.\"",
        "\"Front row's empty and you're standing. That's a tragedy. Sit!\"",
        '"Applause first, introductions after. That\'s the order of things."',
        '"Oh, you\'ll do nicely. I can always tell."',
      ],
      known: [
        '"Twice now! You\'re either a fan or a critic. I adore both."',
        '"That seat again? You have taste. Or habits. Either works."',
        '"Tell me honestly what you thought. No — actually honestly."',
        '"I noticed you noticing. Don\'t stop."',
        '"An audience of one is still an audience. Sit."',
      ],
      warm: [
        "\"You're back! I was hoping you'd return.\"",
        '"I saved you the best seat. Don\'t argue, just take it."',
        '"Tell me honestly — was the second half too much? ...Good. It was meant to be."',
        '"The house was full and I still noticed you missing last time."',
        '"Stay for the encore. I only do encores for a reason."',
      ],
      spark: [
    ...
    approach: {
      ...
      warm: [
        "Take the seat saved for you",
        "Stay for the encore",
        "Break their character",
        "Cheer far too loudly",
      ],
      spark: [
        "Come backstage",
        "Stay past the bow",
      ...
      close: [
        "Go up on stage",
        "Wait for the lights to cool",
        "Applaud the person, not the act",
        "Ask for no audience tonight",
      ],
      bound: [
        "Come to bed",
        "Take the paint off",
    ...
    responses: {
      kind: {
        new: [
          "Admire their presence",
          "Praise the performance",
          "Say the talent is real",
        ],
        spark: [
          "Say what you meant by it",
          "Hold the hand they offered",
          "Praise the person, not the act",
        ],
        close: [
          "Accept both sides of them",
          "Clap for the person underneath",
          "Say the act was never needed",
        ],
        bound: [
          "Say it back",
          "Take the paint off gently",
          "Tell them they needn't perform",
        ],
      },
      playful: {
        new: [
          "Share their spotlight",
          "Heckle affectionately",
          "Demand an encore",
        ],
        spark: [
          "Demand a private encore",
          "Heckle from the front row",
          "Steal the closing line",
        ],
        close: [
          "Delight in both sides",
          "Steal the closing bow",
          "Rehearse the bit with them",
        ],
        bound: [
          "Demand a private show",
          "Undress them slowly",
          "Applaud anyway",
        ],
      },
      bold: {
        new: [
          "Be bold and charming",
          "Upstage them",
          "Ask them to play it for you",
        ],
        spark: [
          "Go backstage",
          "Stay past the bow",
          "Tell them you look for them too",
        ],
        close: [
          "Be the star they want",
          "Take their hand on stage",
          "Tell them to drop the act",
        ],
        bound: [
          "Take them to bed",
          "Say you want the face underneath",
          "Kill the last light",
        ],
      },
      neutral: {
        ...
        close: [
          "Share the spotlight quietly",
          "Sit through the curtain call",
          "Stay after everyone leaves",
        ],
        bound: ["Let the theatre go cold", "Sit in the dark", "Say nothing"],
      },
    },
  },
  ...
  mio: {
    dialogue: {
      new: [
        ...
        "Something in the workshop chimes the hour. He apologizes for it like it was his fault.",
      ...
      known: [
        ...
        "The ready smile has stopped being professional.",
      ],
      warm: [
        ...
        "He hands you the small clockwork piece to hold, so your hands have something to do.",
    ...
    temperamentDialogue: {
      new: [
        ...
        '"Something broken? I can usually manage. Even if it isn\'t a clock."',
      ],
      known: [
        ...
        "\"You're easy to have around. That's a compliment, by the way.\"",
        '"Stay as long as you want. Nobody\'s using the stool."',
      ],
      warm: [
  ...
  shion: {
    dialogue: {
      new: [
        ...
        "He is standing much closer than he was a second ago. You didn't see him move.",
      ...
      known: [
        ...
        "He knows which way you'll walk, and is already standing there.",
      ...
      warm: [
        ...
        "He offers his arm. The gesture is old-fashioned, courteous, and faintly ominous.",
      ],
      spark: [
    ...
    temperamentDialogue: {
      new: [
        ...
        '"Come closer. I promise the mask is the least interesting thing about me."',
      ...
      known: [
        ...
        '"Come along. The scenery is better where I\'m standing."',
      ...
      warm: [
        ...
        '"Stay where I can see you. Indulge me."',
      ],
      spark: [
        ...
        '"I could frighten you again. I\'d much rather do this instead."',
      ],
      close: [
  ...
  jiro: {
    dialogue: {
      new: [
        ...
        "The pen doesn't stop moving. Neither does the conversation, apparently, since it never started.",
        "He assesses you clinically for two seconds and returns to the chart. You've been diagnosed as fine.",
      ...
      known: [
        ...
        "He answers a question properly instead of telling you to leave.",
      ...
      warm: [
        ...
        "He asks a blunt question about your health, and waits for the honest answer.",
    ...
    temperamentDialogue: {
      new: [
        ...
        '"You\'re wasting daylight standing there."',
      ],
      known: [
        ...
        '"Still standing. Still not bleeding. Good."',
  ...
  yuri: {
    dialogue: {
      new: [
        ...
        '"Sit. Roll up your sleeve. No, I don\'t have to explain myself."',
      ],
      known: [
        ...
        '"Hm," he says, and lets you stay. That is the entire concession.',
    ...
    temperamentDialogue: {
      ...
      warm: [
        ...
        '"Stop looking at me like that. It\'s distracting and I have work."',
      ],
      spark: [
      ...
      close: [
        ...
        '"You\'re my patient. That word means something coming from me."',
  ...
  ren: {
    dialogue: {
      new: [
        ...
        "He's been in that exact position long enough that the light has moved off him.",
      ],
      known: [
        "Both earbuds come out. That's a significant escalation.",
        "\"Oh, it's you,\" he says, and doesn't go back to the phone right away.",
        "He's moved his bag off the seat before you got there.",
    ...
    temperamentDialogue: {
      new: [
        ...
        '"If you\'re looking for somebody loud, wrong house. Wrong guy, too."',
        "\"Nah, I'm not doing anything. That's kind of the point.\"",
        '"Cool. Yeah. Anyway."',
      ],
      known: [
        '"Oh — hey. You can sit, if you want. Whatever."',
        '"You watch this one? ...Okay. Cool. Cool."',
  ...
  haru: {
    dialogue: {
      new: [
        ...
        "He's coaxing something out from under a crate, murmuring to it. He doesn't look up. \"One second — nearly got him.\"",
        "He smells like feed and straw and something faintly sulfurous, and seems entirely unbothered by all three.",
        'Something skitters behind him. "Ignore that," he says cheerfully. "That one\'s supposed to be in a pen."',
      ],
      known: [
        "He's got a nickname for you now. He's testing which one lands.",
        ...
        "He appears at your elbow with straw in his hair and no explanation for any of it.",
      ],
      warm: [
        "His whole face lights up when he sees you—genuine delight, the kind that makes his warmth impossible to resist.",
        "He's up to the elbows in an enclosure and still finds a hand to wave with.",
        "He's teaching you the feeding order. He is extremely serious about the feeding order.",
        "Peekaboo comes out when you arrive now. Haru says that has never once happened before.",
        '"Ojou-chan!" he calls, over the noise of about nine different anomalies.',
      ],
      spark: [
    ...
    temperamentDialogue: {
      new: [
        ...
        '"You didn\'t flinch. Huh. Most people flinch. I like you already."',
      ],
      known: [
        '"Hey, you! Okay — I\'ve got three nicknames. Pick your least favorite."',
        "\"Perfect timing, I'm doing the evening rounds. You're coming. That's not a question.\"",
        '"Peekaboo likes you. That\'s rare. He hates literally everyone."',
        '"You keep turning up where I am. Suspicious. Continue."',
        "\"Careful, that one's in a mood. ...Okay, that one's always in a mood.\"",
      ],
      warm: [
      ...
      spark: [
        '"Trouble or destiny? I\'ve picked. Guess which."',
        '"I flirt with everyone. I mean it with you. Big difference, Ojou-chan."',
      ...
      close: [
        ...
        "\"Everywhere's better with you in it. That's not a line, it's just true.\"",
      ...
      bound: [
        '"C\'mere, Ojou-chan. No joke this time. Not even a small one."',
        ...
        "\"Peekaboo picked you before I'd admit I had. He's insufferably smug about it.\"",
      ],
    },
    approach: {
      new: [
  ...
  towa: {
    dialogue: {
      new: [
        ...
        "He tilts his head, slowly, the way something decides whether you're interesting.",
      ...
      known: [
        ...
        "He mouths something. It might be your name. He doesn't say it aloud yet.",
      ...
      warm: [
        ...
        "The unblinking stare softens into something almost like relief.",
    ...
    temperamentDialogue: {
      ...
      warm: [
        ...
        "\"Don't go yet. Please don't go yet.\"",
  ...
  edward: {
    dialogue: {
      new: [
        ...
        "The candlelight suits him unfairly well. He's aware. He arranged it.",
      ],
      known: [
        ...
        "He asks after your week, and listens to the whole answer.",
      ...
      warm: [
        ...
        "He rearranges his entire evening around your arrival and calls it a coincidence.",
    ...
    temperamentDialogue: {
      new: [
        ...
        '"A guest! It has been an age since anyone visited on purpose."',
      ],
      known: [
        ...
        '"Tell me about your week. I\'ve a great deal of time and very little to fill it."',
      ],
      warm: [
        ...
        '"You do keep me waiting. I find I don\'t mind it from you."',
      ],
      spark: [
  ...
  rui: {
    dialogue: {
      new: [
        ...
        "The cheer arrives a half-second before he does, which is somehow very him.",
      ],
      known: [
        'He\'s stopped saying "not too close." He just leaves the distance where it is.',
        '"Hey, you!" He\'s got your name now and uses all of it, every single time.',
        "There's a note on his desk with your name on it, in that neat handwriting.",
      ...
      warm: [
        ...
        "He's got your name on something in that neat handwriting of his. He'll pretend it's admin.",
    ...
    temperamentDialogue: {
      ...
      known: [
        ...
        '"I wrote your name down. For scheduling. Obviously. Only reason."',
      ...
      warm: [
        ...
        "\"I saved you a seat. It's the good one. Don't tell the others.\"",
        "\"Hands to myself, promise. Doesn't mean I'm not thrilled you're here.\"",
        '"You always show up right when it\'s getting heavy. How do you do that?"',
      ],
      spark: [
        ...
        '"I think about it constantly. You should probably know that."',
  ...
  lyca: {
    dialogue: {
      new: [
        ...
        "He's noticed something about you that you didn't know showed.",
      ...
      known: [
        ...
        '"You came back," he says, filing that away somewhere as important.',
      ...
      warm: [
        ...
        "He shows you something he learned this week, proud in a very quiet way.",
      ],
      spark: [
    ...
    temperamentDialogue: {
      ...
      known: [
        ...
        '"Stand there. Not because I\'m wary. Because I can see you better."',
      ],
      warm: [
      ...
      spark: [
        ...
        "\"You smell like you. That's — I don't know how to say it better than that.\"",
  ...
  taiga: {
    dialogue: {
      new: [
        ...
        "He laughs at nothing, loudly, and watches to see whether it rattled you.",
      ],
      known: [
        ...
        "He looks up, sees it's you, and doesn't reach for anything under the table.",
      ...
      warm: [
        ...
        "He shoves a drink at you and immediately looks somewhere else.",
    ...
    temperamentDialogue: {
      new: [
        ...
        '"Tch. Another stray wanders in. Watch your damn step."',
      ],
      known: [
        ...
        '"Hah! You\'ve got a face for this game. Terrible one. Sit anyway."',
      ],
      warm: [
        ...
        '"You gonna play, or just stand there lookin\' pleased with yourself?"',
      ],
      spark: [
  ...
  ritsu: {
    dialogue: {
      new: [
        ...
        '"Before we proceed — three questions. They\'re brief. Mostly."',
      ...
      known: [
        ...
        "The verbosity is unchanged. The pauses for your answer are new.",
        "Your name is in the margin of something — a note to consult you.",
      ],
      warm: [
    ...
    temperamentDialogue: {
      new: [
        ...
        '"I bill by the hour. For you, we\'ll call this a consultation. Free of charge."',
      ],
      known: [
        ...
        '"Sit. This will take a moment and I\'d rather you were comfortable."',
      ],
      warm: [
  ...
  romeo: {
    dialogue: {
      new: [
        ...
        '"Do you know what this floor makes an hour? No? Then walk faster."',
      ...
      known: [
        ...
        "He uses your name in the middle of yelling at somebody else.",
    ...
    temperamentDialogue: {
      new: [
        ...
        '"Do you have money? No. Of course you don\'t. Nobody ever does."',
        '"Fine, FINE, I\'ll explain it once. Listen properly."',
      ...
      known: [
        ...
        '"You want something? Everyone wants something. What is it. Quickly."',
