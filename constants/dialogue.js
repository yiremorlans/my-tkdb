...
export const DIALOGUE = {
  jin: {
    ...
    temperamentDialogue: {
      new: [
        ...
        '"Don\'t just stand there like an idiot. State your business."',
      ...
      known: [
        ...
        '"A class C anomaly? Miss me with that weak shit. That is what a Vice Captain is for."',
        '"Your schedule is not my problem. Arrange it around me."',
  ...
  kaito: {
    dialogue: {
      new: [
        ...
        "He spots you and brightens. \"You're new? Ask me anything — I'm pretty savvy about Darkwick.\"",
      ],
      known: [
        ...
        "He's mid-dodge around a corner. \"Shit, it's Luca — he'll rope me into training. ...Oh. Just you. Phew.\"",
    ...
    temperamentDialogue: {
      ...
      known: [
        ...
        "\"Have you been on WickHive yet? Someone leaked next month's cafeteria menu! Oh... wait, I already told you that, didn't I?\"",
  ...
  lucas: {
    ...
    temperamentDialogue: {
      new: [
        ...
        "\"You're ten minutes early. I'm impressed. Let's check the details for today's mission.\"",
      ],
      known: [
        '"Ah — it\'s you. I mean, of course it is. Hello."',
        "\"You've been coming by more often. That's... that's good.\"",
        '"Tough, training every day? Those with strength have a duty to use it for others. I\'m all right."',
        '"I invited Kaito to train again. He refused. I worry about his lack of strength."',
  ...
  tohma: {
    ...
    temperamentDialogue: {
      new: [
        ...
        '"Well, well. A new face. Frostheim is ruled by a king — I am no more than his servant."',
      ...
      known: [
        '"Providing this level of assistance goes without saying. Do it without instruction and you might call yourself qualified."',
  ...
  alan: {
    dialogue: {
      ...
      known: [
        ...
        '"Another mission order came in," he says. "More anomalies in the summer. Figures."',
    ...
    temperamentDialogue: {
      ...
      warm: [
        ...
        '"Sit. I\'m almost done."',
        '"You came back. Good."',
        "\"You eat? ...I forgot again. Cafeteria portions aren't big enough, that's the only reason.\"",
  ...
  leo: {
    dialogue: {
      new: [
        ...
        '"Who\'s DMing me? Oh, this account..." He glances up at you mid-scroll. "Huh. Hold that thought."',
      ],
      known: [
      ...
      warm: [
        ...
        '"They want us in the Pit again. Which house? ...Ugh, pass." He stays right where he is, next to you.',
      ],
      spark: [
  ...
  shohei: {
    dialogue: {
      new: [
        ...
        '"Huh? Was that your stomach?" He\'s already reaching for a pan. "You\'re hungry. Sit down."',
      ],
      known: [
        ...
        '"It\'s Sho, by the way. Not Shohei. Nobody calls me Shohei."',
      ...
      warm: [
        ...
        "\"Pit's on again? I'm done with that. They're all normies — what's the point? Stay here, eat.\"",
      ],
      spark: [
    ...
    temperamentDialogue: {
      ...
      known: [
        ...
        "\"Mido texted me. 'Come to the pit,' spelled three ways, none right. The hell is this, some kinda secret code?\"",
      ],
      warm: [
  ...
  subaru: {
    dialogue: {
      new: [
        ...
        '"I\'ve been working since I was four," he says, almost apologetic. "People called me mature. Mostly I\'m still learning."',
      ...
      known: [
        ...
        "\"Sorry I'm late — the campus is so crowded I can never walk in a straight line. Silly, isn't it?\"",
      ],
      warm: [
        ...
        '"I\'m captain in name only," he says mildly. "Haku is far better suited to it than I am."',
      ],
      spark: [
    ...
    temperamentDialogue: {
      ...
      known: [
        ...
        '"I never thought I\'d get to enjoy student life until Darkwick. Every day here is fulfilling."',
  ...
  zenji: {
    dialogue: {
      new: [
        'He greets you with a flourish, straw hat tipped. "Why, hello there, my dear. Suppose we kick off another swanky day?"',
        ...
        '"Come to see me? How troubling." A slow grin. "I\'m afraid I\'m fresh out of autographs."',
      ],
      known: [
        '"The wanderer returns." He looks delighted. "My dear, you\'re becoming a regular fixture."',
        'He sets the biwa across his knee. "This? A biwa, of course. A biwa, just as you are yourself."',
    ...
    temperamentDialogue: {
      new: [
        ...
        "\"Suppose we kick off another swanky day here? The evening's the cat's pajamas for it.\"",
      ],
      known: [
        ...
        '"You want the meaning of my words? I see — I\'ll have to give you a lecture on romanticism."',
      ],
      warm: [
        '"You return like seasons turning. My heart is at ease."',
        '"I was writing about rain. You\'ve made it about something warmer."',
        '"My ideal summer? The springs of Yugawara, my burdens set down, my wordsmithery pursued in peace. You\'d be welcome along."',
  ...
  haku: {
    dialogue: {
      new: [
        ...
        '"Don\'t expect much from me," he says lightly. "I\'m human — a glorified street magician, really."',
      ],
      known: [
      ...
      warm: [
        ...
        "\"Zenji's wandered off again. People are raw this time of year — I wish he'd just stay put.\"",
      ],
      spark: [
    ...
    temperamentDialogue: {
      new: [
        ...
        "\"Haha. Let's keep it light, huh? Don't expect too much from me.\"",
      ],
      known: [
  ...
  elias: {
    dialogue: {
      new: [
        ...
        '"Just handling the odd jobs around here," he says. "Anything you need, don\'t hesitate to ask."',
        "He smiles like it's free. It isn't, and you both know it.",
      ],
      known: [
        '"Was tidying up," he says. "Don\'t really have to anymore. Can\'t help myself."',
      ...
      warm: [
        'He looks up and actually smiles. "Seeing you always makes my day. I mean that one plain."',
        ...
        '"Setting up the bamboo — Shion wants nagashi somen. Stay, if you\'ve got the afternoon."',
    ...
    temperamentDialogue: {
      new: [
        ...
        '"I was about to take a walk around campus. Just doing my part staying healthy."',
        "\"You've got good instincts, walking slow like that. Keep 'em.\"",
        '"Oh, I just handle the odd jobs around here. Anything you need, don\'t hesitate to ask."',
      ],
      known: [
        '"Well. If it isn\'t the persistent one."',
        "\"Just tidying up. I know I don't have to anymore, but... well. Can't help myself.\"",
      ...
      warm: [
        ...
        '"Nice to see everyone in good spirits. Here\'s hoping this peace lasts."',
      ],
      spark: [
  ...
  mio: {
    dialogue: {
      new: [
        ...
        "\"Whoa, hold up — you don't wanna run here. The floor's not level.\"",
      ...
      warm: [
        ...
        '"Shion wrecked something again. I was low on parts anyway — walk with me to the campus store?"',
    ...
    temperamentDialogue: {
      ...
      known: [
        ...
        '"You think I look busy? Takes one to know one. Give yourself a break sometime."',
        '"Heading to the campus store — not shopping, more like restocking. Come along, Honor roll."',
      ],
      warm: [
  ...
  shion: {
    dialogue: {
      ...
      warm: [
        ...
        '"I\'m thirsty. Go to Elias\'s and bring me that sickly brown stuff." A beat. "Please. There."',
      ],
      spark: [
    ...
    temperamentDialogue: {
      ...
      warm: [
        ...
        "\"I'm thirsty. Fetch me the brown stuff from Elias's. ...You'll do it. You like me.\"",
      ],
      spark: [
  ...
  jiro: {
    dialogue: {
      new: [
        ...
        '"Are you dead?" He glances up. "...No. Alive. Good. Carry on."',
      ...
      known: [
        ...
        '"Someone asked me to end it, so I gave them what they asked for. I don\'t debate ethics after the fact."',
      ...
      warm: [
        ...
        "He's favoring one side. \"Sutures. From the Clash. Yuri keeps saying he'll redo them.\" He doesn't sit.",
    ...
    temperamentDialogue: {
      new: [
        ...
        '"I don\'t like unproductive discussions. Like this one. State your business."',
      ],
      known: [
  ...
  yuri: {
    dialogue: {
      new: [
        ...
        '"You should feel honored — chosen as a test subject of Dr. Yuri Isami, genius and visionary!"',
      ],
      known: [
        ...
        '"Are you injured or ill? Oh dear, how unfortunate. I shall begin the experi— ahem. The treatment. At once."',
    ...
    temperamentDialogue: {
      new: [
        ...
        "\"I am a very busy man. If you don't require examination, then we're done here.\"",
      ],
      known: [
        "\"Oh. It's you. Don't touch anything, but... you may sit.\"",
        "\"You're less useless than average. Don't celebrate.\"",
        '"JIRO! ...Where is that man. Ignore me. Sit, you — sit."',
      ...
      close: [
        ...
        '"I preserve the lives of my patients. Other parts, no guarantees. But you — you I keep whole."',
  ...
  ren: {
    dialogue: {
      new: [
        ...
        '"Just got off a shift at the Mystery Diner. Summer\'s the busy season. Was back home too. Whatever."',
      ],
      known: [
        "Both earbuds come out. That's a significant escalation.",
        "\"Oh, it's you,\" he says, and doesn't go back to the phone right away.",
        '"Senpai — did you open the link I sent? No, you don\'t have to sign up or anything. ...Thanks."',
    ...
    temperamentDialogue: {
      new: [
        ...
        "\"If you've got time to stand there, go feed the aquatic zone. I'm too busy.\" (He isn't.)",
        "\"Nah, I'm not doing anything. That's kind of the point.\"",
        '"Cool. Yeah. Anyway."',
      ],
      known: [
        '"Oh — hey. You can sit, if you want. Whatever."',
        '"Doing it for your friends, the animals, whatever — save it. People who talk like that are kidding themselves."',
  ...
  haru: {
    dialogue: {
      new: [
        ...
        '"Phew — just finished harvesting the feed crops. Everyone\'s health depends on the quality, so you do it right."',
      ...
      known: [
        ...
        '"Folks are wild for the Anomalous Animal Back to Nature Tour. Discount rate! Here — help me hand out fliers."',
      ],
      warm: [
        "His whole face lights up when he sees you—genuine delight, the kind that makes his warmth impossible to resist.",
        '"You reckon I work hard? Nah — nothing to write home about." He\'s filthy to the elbows and beaming.',
    ...
    temperamentDialogue: {
      ...
      known: [
        ...
        "\"Everyone stuffs up sometimes. Don't let it get to you — it's a funny story for later. Gahaha!\"",
      ],
      warm: [
      ...
      spark: [
        ...
        '"I flirt with everyone. I mean it with you. Big difference, Honor roll."',
  ...
  edward: {
    dialogue: {
      new: [
        ...
        '"The most powerful vampire? Goodness, no. Only rumors." He smiles as if it amuses him.',
      ],
      known: [
        ...
        "\"Ah, there you are. I've a favor to ask — come to my room, and I'll explain.\"",
      ...
      warm: [
        ...
        'He winces, a hand at his ribs. "Rui touched me again earlier. The ache lingers. Forgive me — I\'ll sit."',
    ...
    temperamentDialogue: {
      new: [
        ...
        '"I\'ve no interest in harming humans. You die so quickly — better you enjoy the brief while you have."',
      ],
      known: [
        ...
        "\"I'm confined to this house most days. On my best behavior. But I'll help you from the sidelines where I can.\"",
      ],
      warm: [
        ...
        '"Before Darkwick? I eked out a humble existence in Eastern Europe. Nothing worth the telling."',
      ],
      spark: [
  ...
  rui: {
    dialogue: {
      new: [
        ...
        'He\'s got Edward slung over one shoulder. "Ed popped out of nowhere, I touched him, he died again. One sec — dorm run."',
      ],
      known: [
        'He\'s stopped saying "not too close." He just leaves the distance where it is.',
        '"Oh hey, it\'s Honor roll!" He beams. "So random running into you — guess we\'ve gotta hang out now."',
        '"You look kinda tired, Honor roll. Stop by the bar later? I can be your shoulder to cry on."',
    ...
    temperamentDialogue: {
      ...
      known: [
        ...
        '"Aw, c\'mon — Ed left his socks out again. Picking up after this house is exhausting, Honor roll."',
      ...
      warm: [
        ...
        "\"We finally get to spend some time together — it's illegal to take your eyes off me, y'know.\"",
      ],
      spark: [
        ...
        "\"Were you just checking me out, Honor roll? Hey — it's all good, don't be embarrassed.\"",
  ...
  lyca: {
    dialogue: {
      new: [
        ...
        'The phone in his pocket buzzes and he flinches hard. "Why do I have to carry this thing everywhere? It\'s scary."',
      ...
      known: [
        ...
        '"When I find Neros, I want to show him I get along with humans. Then he\'ll let me live with him."',
      ...
      warm: [
        ...
        '"Going to practice swimming at Harurin\'s. You do anything besides doggy paddle?"',
      ],
      spark: [
    ...
    temperamentDialogue: {
      ...
      known: [
        ...
        '"Have you seen the moth-eaten Casanova? Edward. I\'m gonna show him my special move today."',
      ],
      warm: [
  ...
  taiga: {
    dialogue: {
      new: [
        ...
        '"Who the hell are you again?" He squints. "...Whatever. Sit down."',
      ],
      known: [
      ...
      warm: [
        ...
        'He\'s eating something charred off a skewer. "Anomaly meat. Want some? ...Fine, more for me."',
    ...
    temperamentDialogue: {
      new: [
        ...
        "\"Heads or tails, even or odd, on or off... it's all so fuckin' tedious. ...Oh. You're real. Hey.\"",
      ],
      known: [
        ...
        "\"Playin' with these morons is exhausting. Lulu bitches if I win too much. Sit — you're better company.\"",
      ],
      warm: [
        ...
        "\"This place is boring tonight. C'mon — we're gettin' food. Ciao, losers.\"",
      ],
      spark: [
  ...
  ritsu: {
    dialogue: {
      new: [
        ...
        '"What business do you have with me? I charge 5500 yen per half hour, tax inclusive."',
      ...
      known: [
        ...
        '"Have you seen Hoshibami? Strange. My behavioral model places him in the casino at this hour."',
        "\"I'm assigned to Sinostra. They will not stand trial, whatever they've done. Shinjo family policy.\"",
      ],
      warm: [
    ...
    temperamentDialogue: {
      ...
      known: [
        ...
        '"Any self-respecting inspector stays ahead of schedule. Get into the habit. Let\'s go — no time to waste."',
      ],
      warm: [
  ...
  romeo: {
    dialogue: {
      new: [
        ...
        "\"Come to my private office later. I've a proposal you'll want to hear. Come alone.\"",
      ...
      known: [
        ...
        '"Have you seen Shinjo? I asked him to organize the documents and he ran off to make COPIES."',
    ...
    temperamentDialogue: {
      new: [
        ...
        "\"Tch. If you don't have business for me, I'm leaving. You're wasting my precious time!\"",
        '"Have you seen Fuji-kun? He owes the casino a FORTUNE and he keeps — ugh, never mind."',
