...
// and NO stage directions anywhere. `line` is the follow-up nag that arrives
// before the selfie loads, `greeting` is painted onto the selfie and reveals
// the caption it came with, and every `close`
